import { HydratedView } from '../../domain/ports.ts';
 ...
 */
export const telegramViewRenderedAdapter = async (hydratedView: HydratedView, chatId: number | string): Promise<TelegramMessage[]> => {
 ...
 */
const convertMessageComponent = (component: any, chatId: number | string): TelegramMessage => {
  return {
    chat_id: chatId,
    text: component.props.text,
    parse_mode: 'HTML',
    reply_markup: component.props.actions ? createInlineKeyboard(component.props.actions) : undefined
  };
};
 ...
 */
const convertCardComponent = (component: any, chatId: number | string): TelegramCardMessage => {
 ...
 */
const convertProductCardComponent = (component: any, chatId: number | string): TelegramCardMessage => {
  let text = `<b>${component.props.title}</b>`;
  ...
  const replyMarkup: TelegramReplyMarkup | undefined = component.props.actionText && component.props.action ? 
    {
      inline_keyboard: [[{
 ...
 */
const convertBotProductCardComponent = (component: any, chatId: number | string): TelegramCardMessage => {
