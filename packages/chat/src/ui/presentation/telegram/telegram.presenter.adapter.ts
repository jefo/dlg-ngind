import type {
	...
	ButtonComponentDTO,
	CardComponentDTO,
	ProductCardComponentDTO,
	BotProductCardComponentDTO,
 ...
 */
export const telegramViewPresentationAdapter = async (
 ...
 */
const formatProductCardComponent = (
	component: ProductCardComponentDTO,
): string => {
	let text = `<b>${component.props.title}</b>\n`;
 ...
 */
const formatBotProductCardComponent = (
	component: BotProductCardComponentDTO,
): string => {
