			...
			components: [
				{ 
					...
					buttonGroup: { 
						id: randomUUID(), 
						buttons: [
							{ id: randomUUID(), label: "Квалификация лидов", event: "ADD_SELECTION", payload: { value: "qualification" } }, 
							{ id: randomUUID(), label: "Поддержка (FAQ)", event: "ADD_SELECTION", payload: { value: "support" } }, 
							{ id: randomUUID(), label: "Далее", event: "SUBMIT_JOBS" }
						]
					}
				}
			]
			...
			components: [
				{ 
					...
					buttonGroup: { 
						id: randomUUID(), 
						buttons: [
							{ id: randomUUID(), label: "Telegram", event: "ADD_SELECTION", payload: { value: "telegram" } }, 
							{ id: randomUUID(), label: "Веб-сайт", event: "ADD_SELECTION", payload: { value: "website" } }, 
							{ id: randomUUID(), label: "Далее", event: "SUBMIT_CONTEXTS" }
						]
					}
				}
			]
		...
		{ 
			...
			components: [
				{ 
					...
					buttonGroup: { id: randomUUID(), buttons: [{ id: randomUUID(), label: "Долго отвечаем на заявки", event: "SUBMIT_STRUGGLES", payload: { selection: "long_response" } }] }
				}
			]
		},
		{ 
			...
			components: [
				{ 
					...
					buttonGroup: { id: randomUUID(), buttons: [{ id: randomUUID(), label: "Рост конверсии", event: "SUBMIT_OUTCOMES", payload: { selection: "conversion_growth" } }] }
				}
			]
		},
		{ 
